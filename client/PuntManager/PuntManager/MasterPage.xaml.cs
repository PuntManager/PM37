...
namespace PuntManager
{
    ...
    public partial class MasterPage : MasterDetailPage
    {
        ...
        List<MasterPageItem> GetItemSource() {
            ...
            list.Add(new MasterPageItem { Title = "Game", TargetType = new GameList().GetType() });
            list.Add(new MasterPageItem { Title = "Player", TargetType = new PlayerList().GetType() });
            list.Add(new MasterPageItem { Title = "Table", TargetType = new TableList().GetType() });
